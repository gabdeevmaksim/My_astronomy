pro search_for_stars05

DIR='e:\Observations\MMPP\20200321\'
...
for l=0,N_elements(name)-1 do begin
  ...
  openw, 1, DIR+name[l]+'_stars.dat'
  set_plot, 'ps'
  device, file=DIR+name[l]+'_stars.eps', /portrait, xsize=20, ysize=20, yoff=0, xoff=0  
  ...
  for i=0,N-1 do begin 
    ...
    cgplot, v1, v2, /overplot, PSYM=4, Symsize=0.5
    RR=where((v1 gt -.1 and v1 lt .1) and (v2 gt .4 and v2 lt .6) and v1 lt 99.00 and v2 lt 99.00 and mag2 lt 22,ind);and mag2 lt 18.5
    ;print, 'ind', ind, i
